...
Revision ID: b378c37d849f
Revises: a5cffa318ac2
Create Date: 2026-01-30 18:27:33.492191
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('comment_text', sa.String(length=333), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('photo', 'video', 'gif', name='media_type_enum'), nullable=False),
